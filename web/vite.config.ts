...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mt7f6z64-bwhmmt-test",
        short_name: "Create Canary e2e-create-mt7f6z64-bwhmmt-test",
        description: "Create Canary e2e-create-mt7f6z64-bwhmmt-test — free forever",
        start_url: "/",
        display: "standalone",
